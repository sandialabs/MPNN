...
func_args1 = {'mpnn': mpnn, 'beta': beta, 'Vfunc': 'new', 'thermo': 'I0', 'r': r}
func_args2 = {'mpnn': mpnn, 'beta': beta, 'Vfunc': 'saved', 'thermo': 'I1', 'r': r}
func_args3 = {'mpnn': mpnn, 'beta': beta, 'Vfunc': 'saved', 'thermo': 'I2', 'r': r}

f_arg_list = [(thermo_integrand,func_args1), (thermo_integrand,func_args2), (thermo_integrand,func_args3)]
...
## Monte-Carlo integration, not accurate for low T
    ...
    intg_values = intg.integrate_multiple(f_arg_list,
                                     domain=domain,
                                     nmc=nmc)
...
#print(f"{int_method} Estimates (I0, I1, I2) : {intg_values}")
print(TT, nmc, intg_values[0], intg_values[1], intg_values[2])
